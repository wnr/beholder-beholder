 ...
 * -options {colorize}		If set to 'true' logging will be colorized. Default is 'true'.
 * -options {timestamp}		If set to 'true' logging will be timestamped. Default is 'true'.
 * -options {file}				If set to a filename, logging will be done written to the file. Default is 'false'.
 * -options {console}			If set to 'true', logging will be done to the console. Default is 'true'.
 *
...
/*function validateColorize(actual, default) {
